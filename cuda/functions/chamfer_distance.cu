...
extern "C" diopiError_t diopiChamferDistance(diopiContextHandle_t ctx, diopiConstTensorHandle_t xyz1_in,
  ...
  dispatch_float_types_and_half(impl::cuda::chamfer_distance_forward_cuda_kernel_diopi, xyz1.dtype(), GET_BLOCKS(batch_size * n), THREADS_PER_BLOCK, stream,
                batch_size, n, xyz1.data(), m,
                xyz2.data(), dist1.data(),
                static_cast<int*>(idx1.data()));
  dispatch_float_types_and_half(impl::cuda::chamfer_distance_forward_cuda_kernel_diopi, xyz1.dtype(), GET_BLOCKS(batch_size * m), THREADS_PER_BLOCK, stream,
...
extern "C" diopiError_t diopiChamferDistanceBackward(
  ...
  dispatch_float_types_and_half(
                impl::cuda::chamfer_distance_backward_cuda_kernel_diopi,
                xyz1.dtype(),
