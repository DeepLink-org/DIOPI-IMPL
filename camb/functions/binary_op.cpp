...
DIOPI_API diopiError_t diopiAdd(diopiContextHandle_t ctx, diopiTensorHandle_t out, diopiConstTensorHandle_t input,
    ...
    DIOPI_CALLCNNL(cnnlTransform_v2(handle, CNNL_POINTER_MODE_HOST, pAlphaIn.get(), descOther.get(), trOther.data(), pBetaIn.get(), descOther.get(), trOther.data()));
...
//     diopiTensorHandle_t otherT = nullptr;

//     if (other->stype == diopi_dtype_float64) {

//     }
//     diopiSize_t oterTSize(other->fval)

//     diopiRequireTensor(ctx, &otherT, )
// }
